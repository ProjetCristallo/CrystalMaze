...
%---------------------------
\section{Compatibilité mobile}
Pour que vos modifications soient effectives sur les applications mobiles, il faut recompiler toute l'application. Pour cela, il vous faut :
\begin{itemize}
\item Installer Cordova
\item etc
\end{itemize}
